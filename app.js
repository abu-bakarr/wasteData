...
var serviceAccount = require('./greenliving-66c20-firebase-adminsdk-17ype-b7c279231c.json');

// initializing the app
firebase.initializeApp({
    credential: firebase.credential.cert(serviceAccount),
    databaseURL: "https://greenliving-66c20.firebaseio.com"
...
var ref = db.ref('greenliving'); //making a reference of the database
